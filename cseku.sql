...
INSERT INTO `vtms_video` (`ID`, `Title`, `Description`, `TagID`, `Link`, `IsEmbed`, `CreationDate`, `CreatorID`) VALUES
...
INSERT INTO `vtms_video_comment` (`CommentID`, `Comment`, `CreatorID`, `VideoID`, `CommentIDTop`) VALUES
...
('{B1E7BD13-6206-4275-A6EB-5BE56E90F9C2}', 'after change test', 'mkazi078@uottawa.ca', '{A5329563-EA17-4240-B632-AC3F1627AAC3}', NULL);
